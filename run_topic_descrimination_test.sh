...
# Classify documents by country - only if not completed for the classifications being tested
...
# Create a comparison table to assess best topic discrimination tactic
python compare_classification_to_csv.py # TODO update